  ...
  return (
    <div className="staff-container">
      <div className="side-bar-staff">
        <h2>
          <FontAwesomeIcon icon={faGroupArrowsRotate} /> Staff page
        </h2>
        {activeTab === "my-club" && <div></div>}
        {activeTab === "sports" && <div> aaaa</div>}
      </div>
      <div className="content-container">
        <div className="header-staff">
          <div className="header-title-staff">
            <div
              className={`child-content-staff ${
                activeTab === "my-club" ? "active" : ""
              }`}
